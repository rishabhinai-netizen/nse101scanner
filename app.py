"""
NSE SCANNER PRO v4.0 — World-Class Trading Platform
=====================================================
v4.0 changes:
- Backtesting engine (walk-forward, no lookahead bias)
- Regime engine RECALIBRATED (RSI 45-60 neutral, vol threshold 1.5x)
- Tooltips on every metric/strategy
- RS filter on Scanner Hub + Dashboard
- SHORT signals excluded from RS filter (low RS = better short)
- Nuclear CSS branding hide (mobile + desktop)
- Fixed KeyError: 'scores' crash
"""
...
with st.sidebar:
    ...
    st.caption("v4.0 — Regime + Backtest")
    st.markdown("---")
